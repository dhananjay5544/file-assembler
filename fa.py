...
def document(option, opt_str, value, parser):
    ...
    if tf is True:
        ...
        for i in string:
            ...
            # comp = str(i)
            # print type(i)
            r = re.findall(r'^.*\.(txt|xls|c|cpp|out|doc|pptx?|pdf)', i)
            if len(r) > 0:
        ...
        os.mkdir("Documents")
        print ("Document Directory is created :)")
...
def compress(option, opt_str, value, parser):
    ...
    if tf is True:
        ...
        os.mkdir("Compressed")
        print( "Zip Directory is created :)")
...
def video(option, opt_str, value, parser):
    ...
    if tf is True:
        ...
        os.mkdir("Video")
        print ("Video Directory is created  :)")
...
def programs(option, opt_str, value, parser):
    ...
    if tf is True:
        ...
        os.mkdir("programs")
        print ("Programs directory is created :)")
...
def pics(option, opt_str, value, parser):
    ...
    if tf is True:
        ...
        os.mkdir("Pics")
        print ("Pics Directory is created :)")
